    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                intent.putExtra("varietas", petsList.get(position).getVarietas());
                intent.putExtra("no_soliter", petsList.get(position).getNo_soliter());
                intent.putExtra("is_aduan", petsList.get(position).getIs_aduan());
                intent.putExtra("tgl_pembelian", petsList.get(position).getTgl_pembelian());
                intent.putExtra("harga_beli", petsList.get(position).getHarga_beli());
